#Last version 07092023
#REMINDER: https://github.com/google/mediapipe
#REMINDER 2: CITE CANONICAL FACE INDECES SOURCE FROM GITHUB
#REMINDER 3: FLIP IMAGE CONSIDERATIONS!!
#REMINDER 4: CHECK HOW THE VIRTUAL ENVIRONMENT WAS CREATED IN NEV (REPLICATE FOR P3002 ENOPHONES)
    ...
    if mode == 0:
       ...
       if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
           ...
           cv2.putText(image, "x: " + str(np.round(x_rot,2)), (500, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
           cv2.putText(image, "y: " + str(np.round(y_rot,2)), (500, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
           cv2.putText(image, "z: " + str(np.round(z_rot,2)), (500, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
           ...
           text_y_offset = 20
           cv2.putText(image, f"Left Eye Landmarks:", (info_left_eye_x, info_ldmk_y), FONT, info_font_size, (0, 255, 0), 2)
           ...
           right_eye_coords = []
           text_y_offset = 20
           cv2.putText(image, f"Right Eye Landmarks:", (info_right_eye_x, info_ldmk_y), FONT, info_font_size, (0, 0, 255), 2)
           ...
           text_y_offset += 15
           cv2.putText(image, f"EAR: {ear_right:.2f}", (info_right_eye_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (0, 0, 255), 2)
           text_y_offset += 15
           cv2.putText(image, f"P2-P6: {A_right:.2f}", (info_right_eye_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (0, 0, 255), 2)
           text_y_offset += 15
           cv2.putText(image, f"P3-P5: {B_right:.2f}", (info_right_eye_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (0, 0, 255), 2)
           text_y_offset += 15
           cv2.putText(image, f"P1-P4: {C_right:.2f}", (info_right_eye_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (0, 0, 255), 2)
           text_y_offset += 15

           #Average EAR
           ear_avg = (ear_left + ear_right) / 2

           cv2.putText(image, f"EAR AVG: {ear_avg:.2f}", (info_ear_avg, info_ldmk_y+text_y_offset), FONT, info_font_size, (0, 255, 255), 2)
           ...
           text_y_offset = 20
           cv2.putText(image, f"Mouth Landmarks:", (info_mouth_x, info_ldmk_y), FONT, info_font_size, (255, 0, 0), 2)
           ...
           text_y_offset += 15
           cv2.putText(image, f"MAR: {mar:.2f}", (info_mouth_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (255, 0, 0), 2)
           text_y_offset += 15
           cv2.putText(image, f"P2-P8: {A_mar:.2f}", (info_mouth_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (255, 0, 0), 2)
           text_y_offset += 15
           cv2.putText(image, f"P3-P7: {B_mar:.2f}", (info_mouth_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (255, 0, 0), 2)
           text_y_offset += 15
           cv2.putText(image, f"P4-P6: {C_mar:.2f}", (info_mouth_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (255, 0, 0), 2)
           text_y_offset += 15
           cv2.putText(image, f"P1-P5: {D_mar:.2f}", (info_mouth_x, info_ldmk_y+text_y_offset), FONT, info_font_size, (255, 0, 0), 2)
       ...
       if cv2.waitKey(5) & 0xFF == ord('r'):
        ...
        if recording:
           cv2.putText(image, "R", (0, 0), FONT, 1, (0, 0, 255), 2)
        elif recording == False:
           cv2.putText(image, "NR", (0, 0), FONT, 1, (0, 0, 255), 2)
       if recording:
